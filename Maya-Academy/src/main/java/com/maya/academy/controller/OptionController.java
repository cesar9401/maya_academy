...
public class OptionController {
    ...
    @DeleteMapping
    public ResponseEntity<Boolean> deleteOptionById(@RequestHeader(value = "Authorization", required = false) String token, @RequestBody Option option) {
        boolean deleted = service.deleteOption(option);
